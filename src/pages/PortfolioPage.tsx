...
const allItems: PortfolioItem[] = [
  ...
  { id: 'p7', cloudinaryId: 'tshirt_my65rk', alt: 'Custom team uniforms', label: 'T-Shirts', category: 'tshirts' },
  { id: 'p8', cloudinaryId: 'mug_uc74ct', alt: 'Corporate gift mugs', label: 'Mugs', category: 'mugs', wide: true },
  { id: 'p9', cloudinaryId: 'gift_uqvsof', alt: 'Personalized birthday gifts', label: 'Gifts', category: 'gifts' },
